% this script has test cases to help you test my_imfilter().
% You should verify that you get reasonable output here before using
% your filtering to construct a hybrid image in assignment1.m. The outputs are
...
%% Setup
test_image = im2single(imread('../Data/pair1_marilyn.bmp'));
